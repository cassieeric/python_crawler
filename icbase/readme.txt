...
Then, base on the second website tags, we collect the thirdd website tags.
Next, we store the collected urls in a txt file.
Finally, we collect the detail info based on the urls in the txt file.
